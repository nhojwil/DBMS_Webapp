...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2014 at 01:49 AM
...
--
ALTER TABLE `account`
 ADD PRIMARY KEY (`AccNo`), ADD KEY `MemberID` (`MemberID`);
...
--
ALTER TABLE `project`
 ADD PRIMARY KEY (`Proj_ID`), ADD KEY `Proj_CatID` (`Proj_CatID`);
...
--
ALTER TABLE `account`
MODIFY `AccNo` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
