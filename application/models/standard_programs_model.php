...
class Standard_programs_model extends BMS_Model
{
...
/**
	* Adds a standard program to the stadard programs table
 	* @scope	public
	* @param	array		std_info
	* @return	string		error (if there's any)
	 */
	function add($a_std_info)
	{
		$s_errors['error'] = '';
		if ($r_result = $this->db->insert(TBL_STANDARD_PROGRAMS, $a_std_info)) {
			return $r_result;
		} else {
