...
class SAP_Controller extends CI_Controller
{
...
/* End of SAP_Controller */

class Sap_Admin extends SAP_Controller
{
	protected $data = array();
	...
	{
		return $this->session->userdata('sap_admin_logged_in');
	}
}
/* End of Sap_Admin */